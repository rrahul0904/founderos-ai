  ...
  return <div className="container" style={{ paddingTop: 28 }}>
    ...
    {plans.map((plan) => <div className="card" key={plan.id} style={{ marginBottom: 14 }}>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginTop: 14 }}>
        ...
        {plan.executionId && !plan.executionCommit ? <button className="agent-btn" disabled={busy !== null} onClick={() => refreshExecution(plan.id)}><b>Refresh execution</b><span>Read the durable worker result and blocker state.</span></button> : null}
